...
$capid = $_GET['cap_id'];
$sql = "SELECT * FROM cap WHERE cap_id='$capid'";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">แก้ไขหมวกเห็ด</h1>

                        <!-- แบ่งฝั่ง ที่1 -->
<div class="row">
  <div class="col-sm-6">
 <form name="form1" method="post" action="cap_up.php" enctype="multipart/form-data">

 <div class="row"> <!-- ชื่อเห็ด -->
    <div class="col-sm-10">
    <input type="hidden" name="cap0" class="form-control" value=<?=$row['cap_id'] ?>  ><br>
    </div>
  </div>
 ...
 <label class="col-sm-3 col-form-label">ลักษณะหมวกเห็ด :</label>
    <div class="col-sm-9">
    <input type="text" name="cap1" class="form-control" value=<?=$row['cap_description'] ?>  ><br>
    </div>
  </div>
...
<a href="cap_show.php" class="btn btn-danger" role="button">ยกเลิก</a>
                    ...
                    <a href="cap_show.php" class="btn btn-secondary" role="button">ย้อนกลับ</a>
                </main>
