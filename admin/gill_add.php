            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">เพิ่มครีบ</h1>

                        <!-- แบ่งฝั่ง ที่1 -->
<div class="row">
  <div class="col-sm-6">
 <form name="form1" method="post" action="gill_insert.php" enctype="multipart/form-data">
  <div class="row"> <!-- ชื่อเห็ด -->
  <label class="col-sm-3 col-form-label">สีของครีบ :</label>
    <div class="col-sm-9">
    <input type="text" name="gill1" class="form-control" placeholder="สีของครีบ" required  ><br>
    </div>
  </div>
...
<div class="card mb-4 mt-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tfoot>
                                        <tr> <!-- ใช้ค้นหา -->
                                            <th>gill_description</th>
                                        </tr>
                                    </tfoot>
                            <?php 
                            $sql ="SELECT * FROM gill
                            ORDER BY gill_description ASC"; //เรียงตามพยัญชนะ
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$row["gill_description"]?></td>
  
                                        <td><a href="gill_edit.php?gill_id=<?=$row["gill_id"]?>" class="btn mb-4">
