...
$stalkid = $_GET['stalk_id'];
$sql = "SELECT * FROM stalk WHERE stalk_id='$stalkid'";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">แก้ไขก้าน</h1>

                        <!-- แบ่งฝั่ง ที่1 -->
<div class="row">
  <div class="col-sm-6">
 <form name="form1" method="post" action="stalk_up.php" enctype="multipart/form-data">

 <div class="row"> <!-- ชื่อเห็ด -->
    <div class="col-sm-10">
    <input type="hidden" name="stalk0" class="form-control" value=<?=$row['stalk_id'] ?>  ><br>
    </div>
  </div>
 ...
 <label class="col-sm-3 col-form-label">ลักษณะก้าน :</label>
    <div class="col-sm-9">
    <input type="text" name="stalk1" class="form-control" value=<?=$row['stalk_description'] ?>  ><br>
    </div>
  </div>
