...
<html lang="en">
    ...
    <div id="layoutSidenav_content">
                <main>
                    ...
                    <h1 class="mt-4">ครีบ</h1>
                    <div class="card mb-4 mt-4">
                            
                            <div class="card-body text-primary"><!--ใส่สีตัวอักษร-->
                                <table id="datatablesSimple">
                                <a href="gill_add.php" class="btn btn-primary" role="button">เพิ่ม</a><br><br>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <a href="gill_del.php?gill_id=<?=$row["gill_id"]?> "  class="btn mb-4" onclick="Del(this.href);return false;">
